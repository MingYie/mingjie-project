...
<%--                                    id和pId 是实现treeTable所必须的--%>
                                    <tr id="${tbContentCategory.id}" pId="${tbContentCategory.parent.id}">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" onclick="checkboxAll.deleteIdSingle('/content/category/delete','${tbContentCategory.id}','警告：此删除会将包括选中类目在内的全部子类目都删除！您确定还要继续吗？')"><i class="fa fa-trash-o"></i> 删除</button>&nbsp;&nbsp;&nbsp;
                                            <a href="/content/category/form?parent.id=${tbContentCategory.id}&parent.name=${tbContentCategory.name}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> 新增下级菜单</a>&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
