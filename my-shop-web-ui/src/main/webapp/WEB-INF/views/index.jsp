...
<div id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            ...
            <c:if test="${tbUser == null}">
                <li class="denglu">Hi~<a class="red" href="/login">请登录!</a> <a href="/regist">[免费注册]</a></li>
            </c:if>
            <li class="shu"></li>
...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${requestScope.ppt}" var="PPT">
        <li><a href="#"><img src="${PPT.pic}" alt="${PPT.title}" title="${PPT.title}"></a></li>
        </c:forEach>
    </ul>
    <ul id="two">
        <c:forEach items="${requestScope.ppt}" var="PPT" varStatus="s">
        <li class="${s.count==1 ? "on" :""}">${s.count}</li>
        </c:forEach>
    </ul>
    <!--轮播图左右箭头-->
