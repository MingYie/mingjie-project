...
<div class="beij_center">
    <div class="dengl_logo">
        <a href="/index.jsp"><img src="/static/images/logo_1.png"></a>
        <h1>欢迎登录</h1>
    </div>
</div>
        ...
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <div class="txt_kuang">
                    ...
                    <img id="verificationCode" src="/verification" style="float: right;padding-right: 33px;cursor: pointer;" title="看不清？换一张">
                </div>
                <div class="remember">
                    <div class="fl">
                        <input type="checkbox" >
            ...
            <div class="corp_login">
                ...
                <div class="regist_link"><a href="/regist" target="_blank"><b></b>立即注册</a></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        // 刷新验证码 给验证码图片添加点击就刷新的事件 先隐藏再添加属性再淡出的链式编程
